...
set env PNR_SDC_FILE 
set env PROCESS_CORNER nom
set env SAVE_LIB ./results/synthesis/twos_complement.lib
set env SAVE_NETLIST ./out.v
set env SAVE_SDF ./results/synthesis/twos_complement.sdf
set env SCRIPTS_DIR openlane/scripts
set env SIGNOFF_SDC_FILE 
